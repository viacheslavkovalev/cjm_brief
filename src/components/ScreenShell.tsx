...
export function ScreenShell({ children, className = "" }: ScreenShellProps) {
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-page px-5 py-6 text-ink md:px-10 md:py-8">
      <img
        ...
        aria-hidden="true"
      />
      <div className={`relative z-10 mx-auto flex min-h-[calc(100vh-48px)] w-full min-w-0 max-w-[760px] flex-col ${className}`}>
        <Logo />
        {children}
      </div>
    </main>
